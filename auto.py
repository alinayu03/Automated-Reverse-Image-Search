...
# this part just fixes an issue with my python environment, remove this if it breaks it
import collections
...
# now we webscrape and use RE to find the information we want
...
# output: what google identifies the image as
